...
public abstract class GuiComponent {
	...
	/**
	 * Gibt zurück, ob das Element den gegebenen Punkt berührt.
	 * 
	 * @param x x-Position des Punktes
	 * @param y y-Position des Punktes
	 * @return ob das Element den Punkt berührt
	 */
	...
	/**
	 * Gibt Informationen über den aktuellen Zustand der Maus an das Element weiter.
	 * 
	...
	/**
	 * Wird aufgerufen, wenn die Maus sich auf das Element bewegt. Kann von erweiternden Klassen überschrieben werden, um dann z.B. Farbänderungen vorzunehmen.
	 * @param event Event mit Informationen zur Maus
	 */
	protected void onMouseOn(MouseEvent event) {}
	
	/**
	 * Wird aufgerufen, wenn die Maus das Element wieder verlässt. Kann von erweiternden Klassen überschrieben werden, um dann z.B. Farbänderungen vorzunehmen.
	 * @param event Event mit Informationen zur Maus
	 */
	protected void onMouseOff(MouseEvent event) {}
	
	/**
	 * Wird aufgerufen, wenn sich die Maus auf dem Element bewegt. Kann von erweiternden Klassen überschrieben werden.
	 * @param event Event mit Informationen zur Maus
	 */
	protected void onMouseMove(MouseEvent event) {}
	
	/**
	 * Wird aufgerufen, wenn mit der linken Maustaste auf das Element geklickt wird. Kann von erweiternden Klassen überschrieben werden, um auf den Klick zu reagieren.
	 * @param event Event mit Informationen zur Maus
	 */
	protected void onLeftClick(MouseEvent event) {}
	
	/**
	 * Wird aufgerufen, wenn mit der rechten Maustaste auf das Element geklickt wird. Kann von erweiternden Klassen überschrieben werden, um auf den Klick zu reagieren.
	 * @param event Event mit Informationen zur Maus
	 */
